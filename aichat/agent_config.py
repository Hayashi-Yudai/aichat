...
MODELS = [
    ...
    AgentModel(org="Google", model_name="gemini-1.5-pro"),
    AgentModel(org="Google", model_name="gemini-2.0-flash-exp"),
    AgentModel(org="Google", model_name="gemini-2.0-flash-thinking-exp"),
